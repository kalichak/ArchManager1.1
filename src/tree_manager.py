...
class ProjectBuilderApp(ttk.Window):
    def __init__(self):
        ...
        try:
            ...
            messagebox.showerror("Erro de Ícone", "Não foi possível carregar os arquivos de ícone. Verifique se eles existem na pasta 'assets'.")
    ...
    def _create_edit_controls(self, parent):
        ...
        # Botões com ícones (verifica se os ícones foram carregados)
